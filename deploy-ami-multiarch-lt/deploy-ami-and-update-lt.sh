...
aws sns publish --region $REGION --topic-arn "arn:aws:sns:$REGION:333333333333:sns2slack_$CHANNEL_NAME" --message "✴️  ✴️   Starting Packer AMI Build for New AMI in $REGION Region = $AMI_NAME ✴️  ✴️  "
